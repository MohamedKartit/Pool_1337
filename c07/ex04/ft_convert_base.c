...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/06 07:41:12 by mkartit           #+#    #+#             */
/*   Updated: 2023/10/06 07:45:17 by mkartit          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_convert_base(char *nbr, char *base_from, char *base_to)
{
	...
	our_nbr = (char *)malloc(sizeof(char) * (lenght_nbrf + 1));
	if (our_nbr)
		return (0);
	ft_putnbr_base_v2(mednbr, base_to, our_nbr);
	our_nbr[lenght_nbrf] = '\0';
	return (our_nbr);
}
